...
sigma = 0.01
new_fc8_weights = tf.Variable(tf.truncated_normal(shape, stddev=sigma))
new_fc8_bias    = tf.Variable(tf.zeros(nb_classes))
logits = tf.matmul(fc7, new_fc8_weights) + new_fc8_bias
